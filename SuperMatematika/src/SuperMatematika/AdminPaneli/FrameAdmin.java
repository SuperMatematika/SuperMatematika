...
public class FrameAdmin extends javax.swing.JFrame {
    ...
    public FrameAdmin(Admin admin) {
        trenutniKorisnik=admin;
        initComponents();
        Navigacija.PromeniPanel(this.pnlMainContent, new PanelAdminMainChoice());
    }
    ...
    private void btnRezultatiTesta1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRezultatiTesta1ActionPerformed
        Navigacija.PromeniPanel(this.pnlMainContent, new PanelAdminRezultatiTesta());
