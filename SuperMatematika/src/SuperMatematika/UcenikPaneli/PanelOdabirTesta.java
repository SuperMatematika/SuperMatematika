 ...
 * @author samed
 */
public class PanelOdabirTesta extends javax.swing.JPanel {

    private Student trenutniKorisnik;

    public PanelOdabirTesta(Student k) {
        trenutniKorisnik = k;
    ...
    private void btnZapocniTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnZapocniTestActionPerformed
        if (cbRedniBrojTesta.getItemCount() != 0) {
            ...
            Navigacija.PromeniPanel(this, new PanelTest(trenutniKorisnik, ID_predmeta, redniBrojTesta));
        } else
