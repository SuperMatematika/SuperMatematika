 ...
 * @author Melida
 */
public class PanelBiranjeOblastiZaProbniTest extends javax.swing.JPanel {

    Student trenutniKorisnik;

    public PanelBiranjeOblastiZaProbniTest(Student tr) {
        trenutniKorisnik = tr;
        initComponents();
    }
    ...
    private void btnStartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnStartMouseClicked
        Navigacija.PromeniPanel(this, new PanelTest(trenutniKorisnik, selektovaneOblasti()));
