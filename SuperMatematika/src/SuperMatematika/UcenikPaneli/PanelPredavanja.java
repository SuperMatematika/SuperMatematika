 ...
 * @author 1
 */
public class PanelPredavanja extends javax.swing.JPanel {
    ...
    public PanelPredavanja(Student tk, Predmet pk) throws SQLException {
        trenutniPredmet = pk;
        trenutniKorisnik = tk;
        initComponents();
...
//        loadLekcije();
    ...
    private void showPdf(java.awt.event.ActionEvent evt) {
        ...
        Navigacija.PromeniPanel(this, new PanelPDFView(trenutniKorisnik, trenutniPredmet, putanja, "predavanja"));
    }
