...
import SuperMatematika.ZajednickeKlase.DBController.GreskaNemaDovoljnoPitanja;
...
public class PanelTest extends javax.swing.JPanel {
    ...
    ArrayList<PanelZadatak> resenjaZadataka = new ArrayList();

    // Ovaj konstruktor se koristi za probni test, sastavlja random test
    public PanelTest(Student tr, ArrayList<String> oblasti) {
        trenutniKorisnik = tr;
    ...
    public PanelTest(Student tr, int ID_predmeta, int redniBrojTesta) {
        trenutniKorisnik = tr;
    ...
    private void bNoviTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNoviTestActionPerformed
        ...
        try {
            ...
            for (Zadatak z : zadaci) {
                resenjaZadataka.add(new PanelZadatak(z));
            }
            this.pnlZadaci.add(resenjaZadataka.get(trenutni));
            this.btnPrethodni.setEnabled(false);
    ...
    private void bProverResenjaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bProverResenjaActionPerformed
        ...
        for (Component c : resenjaZadataka) {
            if (c instanceof PanelZadatak) {
                if (!((PanelZadatak) c).pritisnutJeNekiRadioButton()) {
                    JOptionPane.showMessageDialog(this, "Niste dali odgovor na sve zadatke!");
                    return;
                }
                if (((PanelZadatak) c).odgovorJeTacan()) {
                    brojTacnihOdgovora++;
                }
            }
        }
