...
import SuperMatematika.UcenikPaneli.PanelPredavanja;
import SuperMatematika.UcenikPaneli.PanelZadaci;
 ...
 * @author 1
 */
public class PanelPDFView extends javax.swing.JPanel {
     ...
     */
    public PanelPDFView(Student tr, Predmet pk, String putanja, String previous) {
        trenutniKorisnik = tr;
        trenutniPredmet = pk;
        file = putanja;
        goBack = previous;
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        try {
            switch (goBack) {
                case "zadaci":
                    Navigacija.PromeniPanel(this, new PanelZadaci(trenutniKorisnik, trenutniPredmet));
                    break;
                case "predavanja":
                    Navigacija.PromeniPanel(this, new PanelPredavanja(trenutniKorisnik, trenutniPredmet));
                    break;
            }
        } catch (SQLException ex) {
            Logger.getLogger(PanelPDFView.class.getName()).log(Level.SEVERE, null, ex);
        }
