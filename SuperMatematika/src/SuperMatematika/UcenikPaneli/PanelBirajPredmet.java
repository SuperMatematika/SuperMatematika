 ...
 * @author 1
 */
public class PanelBirajPredmet extends javax.swing.JPanel {
    ...
    public PanelBirajPredmet(Student s, ArrayList<Predmet> predmeti, String prethodno) {
    ...
    private void prikaziOblasti(Predmet p) {
        try {
            switch (this.prethodnik) {
                case "predavanja":
                    Navigacija.PromeniPanel(this, new PanelPredavanja(trenutniKorisnik, p));
                    break;
                case "zadaci":
                    Navigacija.PromeniPanel(this, new PanelZadaci(trenutniKorisnik, p));
                    break;
            }
        } catch (Exception ex) {
