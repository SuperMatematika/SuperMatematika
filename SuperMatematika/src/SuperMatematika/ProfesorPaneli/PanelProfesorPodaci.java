 ...
 * @author Melida
 */
public class PanelProfesorPodaci extends javax.swing.JPanel {

    Profesor trenutniKorisnik;

    public PanelProfesorPodaci(Profesor tk) {
    ...
    private void popuniLabele() {
        lUsername.setText(trenutniKorisnik.getUsername());
        lIme.setText(trenutniKorisnik.getIme());
        lPrezime.setText(trenutniKorisnik.getPrezime());
        lDatumRodjenja.setText(trenutniKorisnik.getDatumRodjenja().toString());
        lPol.setText(trenutniKorisnik.getPol());
